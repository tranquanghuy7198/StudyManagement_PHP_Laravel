      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            @endif
            @if(Auth::check() and $person['who'] != 1)
            <li class="active"><a href="findTeachingClass">Bảng điểm SV</a></li>
            @endif
            @if(Auth::check() and $person['who'] != 2)
                ...
                <div class="blog-archive-left">
                  ...
                  <div class="col-md-12">
                    <div class="title-area">
                        <h2 class="title">Lớp đang giảng dạy</h2>
                        <p> </p>
                    </div>
                  </div>
                  <table style="width: 750px">
                    <thead>
                      <tr>
                        <th colspan="4">Thông tin giảng dạy của giảng viên {{ $teacher['fullName'] }}</th>
                      </tr>
                      <tr>
                        <th style="width: 380px">Tên lớp</th>
