...
<html lang="en">
  <head>
    ...
    <title>Quản lý học tập | Thông tin cá nhân</title>
    <!-- Favicon -->
...
<!-- -------------------------------------------------------------------------------------------------- -->
  ...
  <!-- Start changePassword form -->
  <div aria-hidden="false" role="dialog" tabindex="-1" id="changePassword" class="modal leread-modal fade in">
    <div class="modal-dialog">
      <!-- Start login section -->
      <div id="login-content" class="modal-content">
        <div class="modal-header">
          <button aria-label="Close" data-dismiss="modal" class="close" type="button"><span aria-hidden="true">×</span></button>
          <h4 class="modal-title"><i class="fa fa-key"></i>Đổi mật khẩu</h4>
        </div>
        <div class="modal-body">
          <form action="{!! route('changePassword') !!}" method="post">
            {!! csrf_field() !!}
            <div class="form-group pass_show">
              <input type="password" name="oldPassword" placeholder="Mật khẩu cũ" class="form-control">
            </div>
            <div class="form-group pass_show">
              <input type="password" name="password" placeholder="Mật khẩu mới" class="form-control">
            </div>
            <div class="form-group pass_show">
              <input type="password" name="passwordConfirm" placeholder="Xác nhận mật khẩu" class="form-control">
            </div>
            <div class="loginbox">
              <button class="btn signin-btn" type="submit">Xác nhận</button>
            </div>                    
          </form>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            @if(Auth::check())
            <li class="active"><a href="{{ url('viewPersonalInfo') }}">Thông tin cá nhân</a></li>
            @endif
            <li class="dropdown">
            ...
            @endif
            @if(Auth::check() and $person['who'] != 1)
            <li><a href="{{ url('findTeachingClass') }}">Bảng điểm SV</a></li>
            @endif
            @if(Auth::check() and $person['who'] != 2)
        ...
        <div class="row">
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="single-page-header-left">
              <h2>Hồ sơ cá nhân</h2>
              <p>Quản lý và cập nhật thông tin trong hồ sơ cá nhân</p>
            </div>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
      ...
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
        <div class="panel panel-info">
          <div class="panel-heading">
            <h3 style="color: #FFF" class="panel-title">{{ $person['fullName'] }}</h3>
          </div>
          <div class="panel-body">
            <div class="row">
              <div class="col-md-3 col-lg-3 "> <img alt="User Pic" src="{{asset('images/user-profile.png')}}" class="img-circle img-responsive">
              </div>
              <div class=" col-md-9 col-lg-9 "> 
                <table class="table table-user-information">
                  <tbody>
                    ...
                    <tr>
                      ...
                      @else
                      <td><input class="ButtonStyle" type="date" name="birthdate" value="{!! old('birthdate', isset($person) ? $person['birthdate'] : null) !!}"/></td>
                      @endif
                    </tr>
                    <tr>
                      <td>Số điện thoại</td>
                      <td><input class="ButtonStyle" type="text" name="phone" value="{!! old('phone', isset($person) ? $person['phone'] : null) !!}"/></td>
                    </tr>
                    <tr>
                      <td>Email</td>
                      <td><input class="ButtonStyle" type="text" name="mail" value="{!! old('mail', isset($person) ? $person['mail'] : null) !!}"/></td>
                    </tr>
                    <tr>
                      <td>Địa chỉ</td>
                      <td><input class="ButtonStyle" type="text" name="address" value="{!! old('address', isset($person) ? $person['address'] : null) !!}"/></td>
                    </tr>
                    @if(Auth::user()->who == 1)
                    <tr>
                      <td>Năm vào trường</td>
                      <td>{{ $year = ($person['id'] - $person['id'] % 10000) / 10000 }}</td>
                    </tr>
                    <tr>
                      <td>Khóa học</td>
                      <td>K{{ $year - 1955 }}</td>
                ...
                {!! Form::close() !!}
                <a data-target="#changePassword" data-toggle="modal" href="#" class="btn btn-primary">Đổi mật khẩu</a>
              </div>
            </div>
          </div>
