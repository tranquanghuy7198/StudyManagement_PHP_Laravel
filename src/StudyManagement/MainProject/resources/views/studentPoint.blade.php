...
<html lang="en">
  <head>
    ...
    <title>Quản lý học tập | Bảng điểm</title>
    <!-- Favicon -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="active"><a href="studentPoint">Bảng điểm</a></li>
            @endif
            @if(Auth::check() and $person['who'] != 1)
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
              <h2 class="title">Bảng điểm cá nhân</h2>
              <p> </p>
          </div>
        </div>
        <table style="width: 1030px">
          <thead>
            <tr>
              <th colspan="7">Kết quả học tập của sinh viên {{ $student['fullName'] }}</th>
            </tr>
            <tr>
              ...
              <th style="width: 100px">Giữa kỳ</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $enrol[$i]['classId'] }}</td>
              <td>{{ $enrol[$i]['midterm'] }}</td>
              <td>{{ $enrol[$i]['endterm'] }}</td>
            ...
            <tr>
              <td></td>
              <td></td>
              <td colspan="2">TC đăng ký: {{ $student['enrolCredit'] }}</td>
              <td colspan="2">TC tích lũy: {{ $student['completeCredit'] }}</td>
              <td>CPA: {{ round($student['CPA'], 2) }}</td>
            </tr>
          </tbody>
        </table>
      </div>
