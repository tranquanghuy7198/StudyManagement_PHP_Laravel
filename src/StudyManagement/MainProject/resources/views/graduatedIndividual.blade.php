      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
              <h2 class="title">Kiểm tra điều kiện tốt nghiệp</h2>
              <p> </p>
          </div>
        </div>
        <table style="width: 820px">
          <thead>
            <tr>
              <th colspan="7">Thông tin sinh viên đủ điều kiện tốt nghiệp</th>
            </tr>
            <tr>
          ...
          <tbody>
            @for($i=0; $i < count($eligibleIndividual); $i++)
            <tr>
              <td>{{ $eligibleIndividual[$i]['id'] }}</td>
              <td>{{ $eligibleIndividual[$i]['fullName'] }}</td>
              <td>{{ $eligibleIndividual[$i]['birthdate'] }}</td>
              <td>{{ $CPA[$i] }}</td>
              <td>{{ $type[$i] }}</td>
              <td class="alignRight">
                {!! Form::open(array('route' => 'studyPath', 'method' => 'post')) !!}
                {!! Form::hidden('id', $eligibleIndividual[$i]['id']) !!}
                <button class="ButtonStyle" type="submit"><i class="fa fa-table button edit" style="font-size:20px"></i></button>
                {!! Form::close() !!}
              </td>
              <td class="alignRight">
