          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="{{ url('studyPath') }}">Lộ trình học</a></li>
                @endif
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="{{ url('classList') }}">Danh sách lớp</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="{{ url('listTeacher') }}">Danh sách giảng viên</a></li>
                <li><a href="{{ url('editAdminList') }}">Danh sách quản trị viên</a></li>
                <li><a href="{{ url('editCourseList') }}">Danh sách học phần</a></li>
                <li><a href="{{ url('editClassList') }}">Danh sách lớp</a></li>
                <li><a href="{{ url('pointProcess') }}">Xử lý điểm</a></li>
                <li><a href="{{ url('certificate') }}">Cấp bằng</a></li>
              </ul>
            </li>
            @endif
            ...
            <div class="row">
              ...
              <aside class="blog-side-bar">
                  ...
                  <div class="sidebar-widget">
                    <h4 class="widget-title">Lớp giảng dạy</h4>
                    <div class="tag-cloud">
                    @for($i=0; $i < count($class); $i++)
                      <a href="{{ url('givePoint', $class[$i]['classId']) }}">{{ $class[$i]['classId'] }} - {{ $course[$i]['courseName'] }}</a><br>
                    @endfor
                    </div>
                  </div>
                </aside>
              ...
              <div class="col-md-8">
                <div class="blog-archive-left">
                  ...
                  <table style="width: 750px">
                    <thead>
                      <tr>
                        <th colspan="6">Bảng điểm lớp {{ $thisClass['classId'] }}</th>
                      </tr>
                      <tr>
                        <th style="width: 120px">MSSV</th>
                        <th style="width: 330px">Họ và tên</th>
                        <th style="width: 80px">Giữa kỳ</th>
                        <th style="width: 80px">Cuối kỳ</th>
                        <th style="width: 80px">Đánh giá</th>
                        <th style="width: 60px" class="alignRight"></th>
                      </tr>
                    </thead>
                    <tbody>
                      @for($i=0; $i < count($enrol); $i++)
                      <tr>
                        <td>{{ $enrol[$i]['studentId'] }}</td>
                        <td>{{ $student[$i]['fullName'] }}</td>
                        {!! Form::open(array('route' => 'calculatePoint', 'method' => 'post')) !!}
                        {!! Form::hidden('id', $enrol[$i]['studentId']) !!}
                        {!! Form::hidden('classId', $thisClass['classId']) !!}
                        <td><input style="width: 80px" class="ButtonStyle" type="text" name="midterm" value="{!! old('midterm', isset($enrol[$i]) ? $enrol[$i]['midterm'] : null) !!}"/></td>
                        <td><input style="width: 80px" class="ButtonStyle" type="text" name="endterm" value="{!! old('endterm', isset($enrol[$i]) ? $enrol[$i]['endterm'] : null) !!}"/></td>
