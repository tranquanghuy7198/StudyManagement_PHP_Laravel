...
<!-- -------------------------------------------------------------------------------------------------- -->
  ...
  <section id="contact">
    <div class="container">
      ...
      <div style="padding: 0 0 0 210px" class="sidebar-widget">
        <form action="findClassList" method="post">
          {!! csrf_field() !!}
          <div class="search-group">
            <button type="submit" class="blog-search-btn"><span class="fa fa-search"></span></button>
            <input style="width: 300px" type="search" name="classId" placeholder="Nhập vào mã lớp" value="{!! old('classId', isset($class) ? $class['classId'] : null) !!}">
          </div>
        </form>
      </div>
      <table style="width: 750px">
        <thead>
          <tr>
            <th colspan="4">Danh sách các sinh viên của lớp {{ $course['courseName'] }} {{ $class['classId'] }}</th>
          </tr>
          <tr>
