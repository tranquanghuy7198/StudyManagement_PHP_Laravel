...
<html lang="en">
  <head>
    ...
    <title>Quản lý học tập | Tra cứu</title>
    <!-- Favicon -->
...
<!-- -------------------------------------------------------------------------------------------------- -->
              ...
              <div class="col-md-2 hidden-sm hidden-xs">
                <aside class="blog-side-bar">
                  <div class="sidebar-widget">
                    <form action="adminFindStudentFee" method="post">
                      {!! csrf_field() !!}
                      <div class="search-group">
                        <button type="submit" class="blog-search-btn"><span class="fa fa-search"></span></button>
                        <input type="search" name="id" placeholder="MSSV">
                      </div>
                    </form>
                  </div>
                </aside>
                ...
                <div class="blog-archive-left">
                  <div class="col-md-12">
                    <div class="title-area">
                        <h2 class="title">Tra cứu học phí sinh viên</h2>
                        <p> </p>
                    </div>
                  </div>
                  <table style="width: 880px">
                    <thead>
                      <tr>
                        <th colspan="6">Thông tin học phí</th>
                      </tr>
                      <tr>
  ...
  <section id="contact">
    <div class="container">
      ...
      @if(Auth::user()->who == 3)
      <div style="padding: 0 0 0 120px" class="sidebar-widget">
        <form action="adminFindStudentFee" method="post">
          {!! csrf_field() !!}
          <div class="search-group">
            <button type="submit" class="blog-search-btn"><span class="fa fa-search"></span></button>
      ...
      <table style="width: 930px">
        <thead>
          <tr>
            <th colspan="6">Thông tin học phí của sinh viên {{ $student['fullName'] }}</th>
          </tr>
          <tr>
            <th style="width: 150px">Mã học phần</th>
