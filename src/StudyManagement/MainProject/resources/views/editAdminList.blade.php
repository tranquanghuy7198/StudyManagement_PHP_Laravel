...
<!-- -------------------------------------------------------------------------------------------------- -->
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
            <h2 class="title">Tìm thông tin quản trị viên</h2>
            <p> </p>
          </div>
        </div>
        <table style="width: 1100px">
          <thead>
            <tr>
              <th colspan="7">Thông tin toàn bộ quản trị viên trường Đại học Bách Khoa Hà Nội</th>
            </tr>
            <tr>
              ...
              <th style="width: 50px" class="alignRight" data-target="#addAdminList" data-toggle="modal">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ $row['id'] }}</td>
              {!! Form::open(array('route' => 'updateAdminInfo', 'method' => 'post')) !!}
              {!! csrf_field() !!}
              ...
              {!! Form::close() !!}
              <td class="alignRight">
                {!! Form::open(array('route' => 'deleteAdminList', 'method' => 'post')) !!}
                {!! Form::hidden('id', $row['id']) !!}
                <button class="ButtonStyle" type="submit" onclick="return confirm('Bạn có chắc muốn xóa mọi thông tin liên quan tới quản trị viên?')"><i class="fa fa-user-times button delete" style="font-size:20px"></i></button>
                {!! Form::close() !!}
              </td>
            </tr>
            @endforeach
  ...
  <!-- Start addAdminList modal window -->

  <div aria-hidden="false" role="dialog" tabindex="-1" id="addAdminList" class="modal leread-modal fade in">
    <div class="modal-dialog">
      <!-- Start login section -->
      <div id="login-content" class="modal-content">
        <div class="modal-header">
          <button aria-label="Close" data-dismiss="modal" class="close" type="button"><span aria-hidden="true">×</span></button>
          <h4 class="modal-title"><i class="fa fa-user-plus"></i>Thêm quản trị viên mới</h4>
        </div>
        <div class="modal-body">
          <form action="{!! route('addAdminList') !!}" method="post">
            {!! csrf_field() !!}
            <div class="form-group">
              <input type="text" name="fullName" placeholder="Họ và tên" class="form-control">
            </div>
            <div class="form-group">
              <input type="text" name="id" placeholder="Mã số nhân viên" class="form-control">
            </div>
            <div class="loginbox">
